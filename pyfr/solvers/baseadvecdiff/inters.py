...
class BaseAdvectionDiffusionIntInters(BaseAdvectionIntInters):
    def __init__(self, be, lhs, rhs, elemap, cfg):
        ...
        # Generate the additional view matrices
        self._rcpdjac_lhs = self._view(lhs, 'get_rcpdjac_fpts_for_inter')
        self._rcpdjac_rhs = self._view(rhs, 'get_rcpdjac_fpts_for_inter')
...
class BaseAdvectionDiffusionMPIInters(BaseAdvectionMPIInters):
    def __init__(self, be, lhs, rhsrank, rallocs, elemap, cfg):
        ...
        # Generate the second set of view matrices for rcpdjac
        self._rcpdjac_lhs = self._vect_xchg_view(lhs, 'get_rcpdjac_fpts_for_inter')
...
class BaseAdvectionDiffusionBCInters(BaseAdvectionBCInters):
    def __init__(self, be, lhs, elemap, cfgsect, cfg):
        ...
        # Generate the additional view matrix for rcpdjac
        self._rcpdjac_lhs = self._view(lhs, 'get_rcpdjac_fpts_for_inter')
